...
function generateCardsForAdditionEasy() {
  const pairs = [
    [3, 7],
    [2, 8],
    [4, 6],
  ...
  return { target: 10, cards };
}

export default function EasyAddition() {
  ...
  useEffect(() => {
    if (mode === 'addition' && difficulty === 'easy') {
      const { target, cards } = generateCardsForAdditionEasy();
      setTarget(target);
      setCards(cards);
    }
                ...
                <div
                 style={{
                  ...
                  ...(card.matched ? styles.matchedAnimation : {}),
                      ...
                      width: 120, // Fixed width for rectangular shape
                      height: 160, // Fixed height for rectangular shape
                    }}
                  >
